 ...
 *
 * test.percussion.pso.imageedit.services AbstractTemplateExpanderAdaptorTest.java
 *
 */
...
public class AbstractTemplateExpanderAdaptorTest
{
   ...
   public void setUp() throws Exception
   {
      ...
      final IPSGuid tguid1 = context.mock(IPSGuid.class);
      final IPSGuid tguid2 = context.mock(IPSGuid.class); 
   ...
   /**
    * Test method for {@link com.percussion.pso.imageedit.services.AbstractTemplateExpanderAdaptor#expand(javax.jcr.query.QueryResult, java.util.Map, java.util.Map)}.
    */
   @Test
   ...
   /**
    * Test method for {@link com.percussion.pso.imageedit.services.AbstractTemplateExpanderAdaptor#buildNodeMap(javax.jcr.query.QueryResult, java.util.Map)}.
    */
   @Test
   ...
   private QueryResult buildQueryResultExpectations()
   {
      ...
      final IPSGuid guid302 = context.mock(IPSGuid.class);
      final IPSGuid guid303 = context.mock(IPSGuid.class);
   ...
   private class TestableTemplateExpanderAdaptor extends AbstractTemplateExpanderAdaptor
   {
      ...
      /**
       * @see com.percussion.pso.imageedit.services.AbstractTemplateExpanderAdaptor#buildNodeMap(javax.jcr.query.QueryResult, java.util.Map)
       */
      @Override
      ...
      /**
       * @see com.percussion.pso.imageedit.services.AbstractTemplateExpanderAdaptor#isNeedsContentNode()
       */
      @Override
      ...
      /**
       * @see com.percussion.pso.imageedit.services.AbstractTemplateExpanderAdaptor#setNeedsContentNode(boolean)
       */
      @Override
