 ...
 *
 * test.percussion.pso.imageedit.web.impl ImageItemSupportTest.java
 *
 */
...
public class ImageItemSupportTest
{
   ...
   /**
    * Test method for {@link com.percussion.pso.imageedit.web.impl.ImageItemSupport#getChild(com.percussion.cms.objectstore.PSCoreItem)}.
    */
   @Test
   ...
   /**
    * Test method for {@link com.percussion.pso.imageedit.web.impl.ImageItemSupport#findChildEntry(com.percussion.cms.objectstore.PSItemChild, java.lang.String)}.
    */
   @Test
   public final void testFindChildEntry()
   {
      
      final PSItemChildEntry entrya = context.mock(PSItemChildEntry.class);      
      final PSItemChildEntry entryb = context.mock(PSItemChildEntry.class);
      final List<PSItemChildEntry> entries = new ArrayList<PSItemChildEntry>(){{
         add(entrya);
         add(entryb);
      }};
      
      final PSItemField flda = context.mock(PSItemField.class);
      final PSItemField fldb = context.mock(PSItemField.class); 
      
      final IPSFieldValue vala = context.mock(IPSFieldValue.class);
      final IPSFieldValue valb = context.mock(IPSFieldValue.class);
   ...
   /**
    * Test method for {@link com.percussion.pso.imageedit.web.impl.ImageItemSupport#readMetaData(com.percussion.cms.objectstore.IPSItemAccessor, java.lang.Object, java.util.Map)}.
    */
   @Test
   ...
   /**
    * Test method for {@link com.percussion.pso.imageedit.web.impl.ImageItemSupport#writeMetaData(com.percussion.cms.objectstore.IPSItemAccessor, java.lang.Object, java.util.Map)}.
    */
   @Test
   ...
   /**
    * Test method for {@link com.percussion.pso.imageedit.web.impl.ImageItemSupport#readBinaryMetaData(com.percussion.cms.objectstore.IPSItemAccessor, com.percussion.pso.imageedit.data.ImageMetaData, java.lang.String)}.
    */
   @Test
   ...
   /**
    * Test method for {@link com.percussion.pso.imageedit.web.impl.ImageItemSupport#writeBinaryMetaData(com.percussion.cms.objectstore.IPSItemAccessor, com.percussion.pso.imageedit.data.ImageMetaData, java.lang.String)}.
    */
   @Test
   ...
   {
      final PSItemField fld_filename = context.mock(PSItemField.class); 
      final PSItemField fld_ext = context.mock(PSItemField.class); 
      final PSItemField fld_type = context.mock(PSItemField.class); 
      final PSItemField fld_size = context.mock(PSItemField.class); 
      final PSItemField fld_height = context.mock(PSItemField.class); 
      final PSItemField fld_width = context.mock(PSItemField.class); 
   ...
   private void setBinaryReadExpectations(final IPSItemAccessor item)
   {
      ...
      final IPSFieldValue val_filename = context.mock(IPSFieldValue.class);
      final IPSFieldValue val_ext = context.mock(IPSFieldValue.class); 
      final IPSFieldValue val_type = context.mock(IPSFieldValue.class); 
      final IPSFieldValue val_size = context.mock(IPSFieldValue.class);
      final IPSFieldValue val_height = context.mock(IPSFieldValue.class);
      final IPSFieldValue val_width = context.mock(IPSFieldValue.class);
   ...
   private class TestableImageItemSupport extends ImageItemSupport
   {
      ...
      /**
       * @see com.percussion.pso.imageedit.web.impl.ImageItemSupport#findChildEntry(java.util.List, java.lang.String)
       */
      @Override
      ...
      /**
       * @see com.percussion.pso.imageedit.web.impl.ImageItemSupport#getChild(com.percussion.cms.objectstore.PSCoreItem)
       */
      @Override
      ...
      /**
       * @see com.percussion.pso.imageedit.web.impl.ImageItemSupport#readBinaryMetaData(com.percussion.cms.objectstore.IPSItemAccessor, com.percussion.pso.imageedit.data.ImageMetaData, java.lang.String)
       */
      @Override
      ...
      /**
       * @see com.percussion.pso.imageedit.web.impl.ImageItemSupport#readMetaData(com.percussion.cms.objectstore.IPSItemAccessor, java.lang.Object, java.util.Map)
       */
      @Override
      ...
      /**
       * @see com.percussion.pso.imageedit.web.impl.ImageItemSupport#writeBinaryMetaData(com.percussion.cms.objectstore.IPSItemAccessor, com.percussion.pso.imageedit.data.ImageMetaData, java.lang.String)
       */
      @Override
      ...
      /**
       * @see com.percussion.pso.imageedit.web.impl.ImageItemSupport#writeMetaData(com.percussion.cms.objectstore.IPSItemAccessor, java.lang.Object, java.util.Map)
       */
      @Override
