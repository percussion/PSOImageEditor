	    ...
	    <legend id="imageInfoLegend">Image Information</legend>
			<table>
				<tr>
					...
					<td>
						<spring:bind path="image.sysTitle">
							<input name="${status.expression}" type="text" value="${status.value}" on />
						</spring:bind>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
					    <c:out value="${metadata.filename}" />
					</td>
				</tr>				
				<tr>
					<td>Image Extension</td>
					<td>
					    <c:out value="${metadata.ext}" />				
					</td>
				</tr>				
				<tr>
					<td>Image Mimetype</td>
					<td>
					    <c:out value="${metadata.mimetype }" /> 				
					</td>
				</tr>	
				<tr>
					<td>Image Size</td>
					<td>
					    <c:out value="${metadata.size}" /> 				
					</td>
				</tr>				
				<tr>
					<td>Image Width</td>
					<td>
					    <c:out value="${metadata.width}" /> 
					</td>
				</tr>								
				<tr>
					<td>Image Height</td>
					<td>
					    <c:out value="${metadata.height}" /> 
					</td>
				</tr>
				</c:if>
			</table>
